...
import { EnvelopeIcon, PhoneIcon, MapPinIcon, MusicalNoteIcon, CodeBracketIcon, CloudIcon } from '@heroicons/react/24/outline';
          ...
          <div className="md:col-span-2">
            ...
            <ul role="list" className="mt-6 space-y-4">
              <li className="flex items-center">
                ...
                <span className="text-sm text-gray-300">contato@echotech.com</span>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="h-5 w-5 text-gray-400 mr-2" />
                <span className="text-sm text-gray-300">+55 (11) 98765-4321</span>
              </li>
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <div className="flex items-center">
              <div className="flex items-center">
                ...
                <span className="text-white font-bold text-lg">EchoTech</span>
              </div>
              <p className="text-sm leading-5 text-gray-400 ml-4">
                &copy; {new Date().getFullYear()} EchoTech. Todos os direitos reservados.
              </p>
            </div>
